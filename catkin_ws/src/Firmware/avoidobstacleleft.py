...
class ObstacleLeftAvoider:
    ...
    def avoid_left_obstacle(self, distance_obst_avoid): 
    ...
    def avoid_left_obstacle_return(self, distance_obst_avoid): 
    ...
    def block_left_movement(self, message): 

        self.blockmovementleft.publish(message) # It publishes the string message with block or unblock
